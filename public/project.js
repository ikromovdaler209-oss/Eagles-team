...
let questions3 = ["Why do you think people spend so much time on social media nowadays?", "How has technology changed the way people communicate?", 
            ...
            "What water sports are popular in your country?", "Why do people like water sports?", "Do you think having a river or lake has an impact on tourism in the city?", "Are rivers and lakes important to a country?", "Are rivers and lakes good for transport?", "Do you think rivers and lakes attract tourists?",
            "What are the difficulties of learning a new language?", "Why do people learn foreign languages?", "Do you think learning a foreign language is important?", "What can people do to learn a foreign language?", 
            "What's the best way to learn a language?", "Which is better, to study a language alone or to study it in a group?", "What are the advantages and disadvantages of learning a language?", "Some people think that technology has made it unnecessary to learn languages. What do you think?", 
            "What can teachers do to make students obey rules?", "What are some rules that exist in schools or workplaces in your country?", "What should parents do to educate children about laws?", "When people break rules, how are they punished in your country?", 
            "Do you think school rules are important?", "Are children unhappy with the school rules?", "What are the rules people should obey at work?", "What leisure activities do old and young people prefer?", "How do people spend their leisure time in your country?",
            "How does technology affect the way people spend leisure time?", "Is leisure time important for everyone?", "Do you think only old people have time for leisure?", "How can parents help children to be organized?", "What factors should people consider organising events?", 
            "Would you rather be in a car or bus in a traffic jam?", "What are good ways to manage traffic?", "Do you think highways will help reduce traffic jams?", "In what ways can we fix traffic problems?", "Will there be fewer people using cars because of improved public transportation?", 
            "Will there be fewer cars if public transport is free?", "What benefits does public transport bring to the world?", "What needs to be improved in public transport?", "Why do people set goals?", "Why is it important for teenagers to set goals?", "Why should parents encourage children to have ambitions?", 
            "When do young children start setting goals for themselves?", "How would you define success?", "In general, how do people judge or, assess the success of others?", "What does it take to become successful?", "Why is it that some people achieve success faster?", "What factors lead to success?"]
